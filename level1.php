    ...
    <div id="wrap">
        <main role="main">
            <div id="wrap2">
                ...
                <p>A few examples: myInventoryDB, companyinventorydb, stockdb, etc. </p>
                ...
                <form action="level1-output.php" method="post">
                    ...
                    <p>
                        <pre>CREATE TABLE <input type="text" onfocus="this.value=''" name="tablename" value="Enter Table Name...">(<input type="text"  onfocus="this.value=''" name="column1name" value="Enter Column Name..."> VARCHAR(30) NOT NULL)</pre>
                    </p>
                    ...
                    <p>To add a column we must use the ALTER command as well as the ADD command. The alter command is used in conjunction with what we are altering. In this example it will be the table, therefore the command should look like:
                        <pre>ALTER TABLE {Table Name}</pre>. Following this command we need to add a column so we must choose a column name and use the command:
                        <pre> ADD {Columnname} {Datatype} Not Null</pre>
                    </p>
        ...
        ADD <input type="text" onfocus="this.value=''" name="column3name" value="Enter the Column Name 'item_stock'..."> int NOT NULL
                    ...
                    <p>
                        <pre>CREATE TABLE <input type="text" onfocus="this.value=''" name="table2name" value="Enter the second Table Name or 'Locations'..."> (<input type="text" onfocus="this.value=''" name="roomname" value="Enter the Column Name 'room_number'..."> VARCHAR(30) NOT NULL</pre>
                    </p>
                    <hr>
        ...
        ADD PRIMARY KEY <input type="text" onfocus="this.value=''" name="itemID2" value="Enter the name of the item ID again from above..."></pre>
                        </p>
                        <hr>
                        ...
                        <p>
                            <pre>ALTER <input type="text" onfocus="this.value=''" name="tb5name" value="Enter table two's name...">
        ...
        ADD PRIMARY KEY <input type="text" onfocus="this.value=''" name="itemID4" value="Enter the name of the room ID ('roomID')..."></pre>
                        </p>
                        <hr>
                        ...
                        <p>
                            <pre>CREATE TABLE <input type="text" onfocus="this.value=''" name="linktable" value="Enter a value for table three's name..."> (
