...
CREATE TABLE <?php echo $_POST["linktable"]; ?> (
    ...
    FOREIGN KEY (<?php echo $_POST["roomID"]; ?>) REFERENCES <?php echo $_POST["table2name"]; ?>(<?php echo $_POST["roomID"]; ?>)
      ...
      <p text-align: center>For help exporting and querying data make sure to continue on to the <a href="level3.php">Level 3 Tutorial</a>! <?php echo htmlspecialchars($_SESSION["username"]); ?>, you can download the code and export it to any database program by clicking the button below: <br><br>
